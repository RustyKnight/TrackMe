...
//  TrackMe
//
//  Created by KaiZen Enterprises on 28/5/17.
...
public class TrackMe : NSObject {
    ...
    public dynamic class func drawCompass(frame: CGRect = CGRect(x: 0, y: 0, width: 320, height: 320), fillColor: UIColor = UIColor(red: 0.800, green: 0.320, blue: 0.320, alpha: 1.000)) {
    ...
    public dynamic class func imageOfCompass(imageSize: CGSize = CGSize(width: 320, height: 320), fillColor: UIColor = UIColor(red: 0.800, green: 0.320, blue: 0.320, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(imageSize, false, 0)
            TrackMe.drawCompass(frame: CGRect(x: 0, y: 0, width: imageSize.width, height: imageSize.height), fillColor: fillColor)
