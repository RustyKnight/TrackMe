...
//  TrackMe
//
//  Created by KaiZen Enterprises on 16/5/17.
...
public class TrackMe : NSObject {
    ...
    public dynamic class func drawCompass(frame: CGRect = CGRect(x: 0, y: 0, width: 320, height: 320)) {
        ...
        //// Subframes
        let group: CGRect = CGRect(x: frame.minX + 2, y: frame.minY, width: fastFloor((frame.width - 2) * 0.99371 + 0.5), height: fastFloor((frame.height) * 0.98750 + 0.5))
    ...
    public dynamic class func imageOfCompass(imageSize: CGSize = CGSize(width: 320, height: 320)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(imageSize, false, 0)
            TrackMe.drawCompass(frame: CGRect(x: 0, y: 0, width: imageSize.width, height: imageSize.height))
